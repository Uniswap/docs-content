...
Uniswap manages **liquidity pools**, each made up of reserves of two [ERC-20](https://eips.ethereum.org/EIPS/eip-20), and updates price based on pool state.
...
Swap fees are configured by pool and [protocol version](/docs/get-started/concepts/fees). These fees accrue to LPs, and protocol fees may apply when enabled through [governance](/docs/resources/governance/governance-process).
