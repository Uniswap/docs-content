...
Uniswap manages **liquidity pools**, each made up of reserves of two [ERC-20](https://eips.ethereum.org/EIPS/eip-20) tokens, and updates price based on pool state.
