...
## What Range Orders Can and Cannot Do

AMM design makes some limit-order styles possible while others cannot be replicated. The following are four examples of range orders and their traditional counterparts: the first two are possible, and the second two are not.
