...
Swap fees are configured by pool and [protocol version](/docs/get-started/concepts/fees). These fees accrue to LPs, and protocol fees may apply when enabled through [governance](/docs/ecosystem/governance/governance-process).
