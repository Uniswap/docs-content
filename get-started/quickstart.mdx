...
description: Execute your first token swap on Uniswap in under 5 minutes using the Uniswap API, SDK, or Solidity.
---
...
The SDK provides type-safe interfaces and direct wallet integration, but requires more setup. For most use cases, the Uniswap API is simpler and provides better routing through UniswapX.
</Callout>
