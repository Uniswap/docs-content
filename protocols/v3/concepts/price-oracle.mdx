...
`Observation`s may be retrieved via the [`observations`](/docs/protocols/v3/overview#observations) method on v3 pools. However, this is _not_ the recommended way to consume oracle data. Instead, prefer [`observe`](/docs/protocols/v3/overview#observe):
