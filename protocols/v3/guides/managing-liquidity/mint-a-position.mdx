...
Now we can call the internal function we previously wrote in [Setting Up Your Contract](/docs/sdks/v3/guides/getting-started). After that, we can take any liquidity leftover from minting and refund it to `msg.sender`.
