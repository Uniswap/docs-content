...
Let's see it in action for a Foundry script. We will make use of the example - Points Hook from [Building Your First Hook](/docs/protocols/v4/guides/hooks/getting-started).
...
<Callout type="info" title="**CREATE2_DEPLOYER**">
