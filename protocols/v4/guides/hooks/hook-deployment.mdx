...
Let's see it in action for a Foundry script. We will make use of the example - Points Hook from [Building Your First Hook](./your-first-hook.mdx).
...
<Callout title="CREATE2_DEPLOYER" type="note">
