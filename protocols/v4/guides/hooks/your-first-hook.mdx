...
description: Build and test a basic points hook in Uniswap v4 using Foundry.
---
...
_Note: To initiate the swap in the first place, this is where [`UniversalRouter`](/docs/protocols/universal-router/overview) comes into play where we will pass in the [`V4_SWAP`](https://github.com/Uniswap/universal-router/blob/main/contracts/libraries/Commands.sol#L35) command to `UniversalRouter.execute`._
