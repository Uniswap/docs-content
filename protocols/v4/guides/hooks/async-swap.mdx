...
One feature enabled by [custom accounting](/docs/contracts/uniswap-protocol-contracts/v4/guides/custom-accounting) is​​​​‌ AsyncSwap swap. This feature allows hook developers to replace the v4 (v3-style) swap logic.
