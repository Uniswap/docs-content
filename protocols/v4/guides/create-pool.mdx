...
To initialize a Uniswap v4 Pool _without initial liquidity_, developers should call [`PoolManager.initialize()`](/docs/contracts/uniswap-protocol-contracts/v4/reference/core/interfaces/IPoolManager#initialize)
...
Uniswap v4's [PositionManager](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/PositionManager) supports atomic creation of a pool and initial liquidity using [_multicall_](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/base/Multicall_v4). Developers can create a trading pool, with liquidity, in a single transaction:
...
### 3. Encode the [`initializePool`](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/base/PoolInitializer) parameters
Pools are initialized with a starting price
```solidity
...
### 7. Encode the [`modifyLiquidites`](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/PositionManager#modifyliquidities) call
```solidity
