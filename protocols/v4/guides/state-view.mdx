...
1. **[`getSlot0(poolId)`](/docs/protocols/v4/guides/state-view#getslot0)**
...
2. **[`getLiquidity(poolId)`](/docs/protocols/v4/guides/state-view#getliquidity)**
    - Returns `uint128 liquidity` (the total active pool liquidity).
    - Used to assess trading depth and volatility.
3. **[`getPositionInfo(poolId, positionId)`](/docs/protocols/v4/guides/state-view#getpositioninfo)**
...
4. **[`getFeeGrowthGlobals(poolId)`](/docs/protocols/v4/guides/state-view#getfeegrowthglobals)**
