...
If you’re familiar with [Reading Pool State](/docs/contracts/uniswap-protocol-contracts/v4/guides/read-pool-state), you already know that Uniswap v4 uses **extsload** for efficient data access. For onchain usage, we rely on **StateLibrary** within contracts. However, offchain clients cannot rely on an onchain library for state reads. 
...
1. **[`getSlot0(poolId)`](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/lens/StateView#getslot0)**
...
2. **[`getLiquidity(poolId)`](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/lens/StateView#getliquidity)**
    - Returns `uint128 liquidity` (the total active pool liquidity).
    - Used to assess trading depth and volatility.
3. **[`getPositionInfo(poolId, positionId)`](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/lens/StateView#getpositioninfo)**
...
4. **[`getFeeGrowthGlobals(poolId)`](/docs/contracts/uniswap-protocol-contracts/v4/reference/periphery/lens/StateView#getfeegrowthglobals)**
