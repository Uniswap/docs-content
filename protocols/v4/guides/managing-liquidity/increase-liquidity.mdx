---
title: Increase Liquidity (v4)
description: Increase an existing Uniswap v4 position by encoding PositionManager actions and submitting `modifyLiquidities()`.
---
...
See the [setup guide](./setup-liquidity)
