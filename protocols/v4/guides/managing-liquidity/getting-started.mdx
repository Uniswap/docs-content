---
title: Setup v4 Liquidity Management
description: Set up a local Uniswap v4 liquidity management environment with Foundry and PositionManager dependencies.
---
