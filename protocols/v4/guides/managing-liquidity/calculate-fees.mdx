...
With hook introduced in v4, [Dynamic Fees](../concepts/dynamic-fees) is now possible and allow v4 pools to have a flexible and responsive fee structure comparing to v3 pools with static fee tiers(0.05%, 0.3%, 1%). 
