...
Then continue with [Set Up Local Environment](/docs/protocols/v4/guides/hooks/getting-started), [Building Your First Hook](/docs/protocols/v4/guides/hooks/your-first-hook), and [Security Framework](/docs/protocols/v4/security).
