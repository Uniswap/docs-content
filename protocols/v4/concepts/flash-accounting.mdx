...
To see how unlock callback and delta work in a smart contract read [Unlock Callback & Deltas](/docs/contracts/uniswap-protocol-contracts/v4/guides/unlock-callback).
