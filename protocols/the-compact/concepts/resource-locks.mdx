...
description: Learn how Uniswap The Compact resource locks encode allocator, scope, reset period, and token constraints.
---
...
<Callout title="Important Integration Notice" type="warn">
