...
1. The customer checks if they have given the necessary approval to the [Permit2 contract](../../../protocols/permit2/overview) to spend the token they intended to swap through a [`/check_approval`](../../endpoints/v1/swapping/check-approval) request.
