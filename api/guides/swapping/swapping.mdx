---
title: 'Swapping Code Examples'
description: 'Application starter code'
mode: 'wide'
---

import { Tab, Tabs } from 'fumadocs-ui/components/tabs'

<Tabs items={['Ethers TypeScript', 'Fireblocks Python']}>
<Tab value="Ethers TypeScript">
  ```coffeescript 
...
<Tab value="Fireblocks Python">
  ...
  fireblocks = FireblocksSDK(fireblocksApiSecret, fireblocksApiSecret)
