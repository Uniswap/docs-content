---
title: 'Swap Building Prerequisites'
description: 'Technical prerequisites for building with the API'
---

To build with the Uniswap Trading API, you will need the following technical capabilities and environment parameters.
