...
For complete information on the available values and combinations for the `protocols` and `routingPreference` fields, see [Swapping Architecture Overview](/docs/api/guides/swapping/getting-started). A summary is provided below:
