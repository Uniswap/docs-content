...
For complete information on the available values and combinations for the `protocols` and `routingPreference` fields, see the field descriptions in the [/quote](/api-reference/swapping/quote). A summary is provided below:
