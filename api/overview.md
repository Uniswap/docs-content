...
- **Uniswap Protocols** refers to the pools of liquidity created through [protocol smart contracts](/get-started/concepts/amms). These are sometimes referred to as **V2**, **V3**, and **V4** pools. (V1 is not supported by the APIs.) In rare instances these protocols collectively are called **Classic**.
