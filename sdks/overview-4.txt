...
The following examples use **ethersJS** and the **Uniswap V3 subgraph** hosted on The Graph's hosted service. To learn more about Uniswap's subgraphs, visit the [API](../../../../api/subgraph/overview) section.
...
Besides the [concepts](../../../../concepts/uniswap-protocol) section of the Docs, the [Uniswap V3 whitepaper](https://uniswap.org/whitepaper-v3.pdf) is a great introduction to the protocol.
...
Instead, we have to know the keys (indices) of the mapping, we will explore how to do that in the [Pool data guide](./pool-data).
...
You can read more about the older versions of Uniswap in the [V1](https://hackmd.io/@HaydenAdams/HJ9jLsfTz?type=view#Swaps-vs-Transfers) and [V2](https://uniswap.org/whitepaper.pdf) whitepapers, as well as the [V1](/docs/contracts/uniswap-protocol-contracts/v1/overview) and [V2](/docs/contracts/uniswap-protocol-contracts/v2/overview) section in the contract section.
