...
Like explained in the [previous guide](./swapping#executing-a-trade), it is important to set the parameters to sensible values.
...
Now that you're familiar with trading, consider checking out our next guides on [pooling liquidity](/docs/sdks/v4/guides/managing-liquidity/position-fetching) to Uniswap!
