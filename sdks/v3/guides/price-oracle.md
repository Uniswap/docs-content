...
First, we need to create a Pool contract to fetch data from the blockchain. Check out the [Pool data guide](./pool-data) to learn how to compute the address and create an **ethers Contract** to interact with.
...
You can also find an example of a JS multicall in the [Pool data guide](./pool-data).
