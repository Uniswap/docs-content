...
The [slot0 function](/docs/protocols/v3/overview#slot0) represents the first (0th) storage slot of the pool and exposes multiple useful values in a single function:
...
If you are not familiar with the concept of ticks, check out the [`introduction`](/docs/sdks/v3/guides/getting-started).
...
Now that you are familiar with fetching Pool data, continue your journey with the [next example](/docs/sdks/v3/guides/getting-started) on visualizing the Liquidity density of a pool.
