---
description: Fetch and model Uniswap v3 pool state with the SDK for pricing and liquidity workflows.
...
If you are not familiar with the concept of ticks, check out the [`introduction`](/docs/sdks/getting-started).
...
![TickBitmap](./managing-liquidity/images/tickBitmap_cut.png)
