---
description: Track active Uniswap v3 liquidity ranges and position behavior with SDK data models.
...
To fetch all ticks of our Pool, we will use the [Uniswap v3 graph](/docs/api/subgraph/overview).
...
Now that you are familiar with liquidity data, consider checking out our [next guide](/docs/sdks/v3/guides/managing-liquidity/price-oracle) on using Uniswap as a Price Oracle.
