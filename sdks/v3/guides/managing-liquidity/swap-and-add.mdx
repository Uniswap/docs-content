---
description: Combine swaps and liquidity adds with the Uniswap v3 SDK to rebalance position funding.
...
For a more detailed example, check out our [routing guide](/docs/sdks/v3/guides/trading/routing).
