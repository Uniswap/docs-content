...
We described the `getTokenTransferApproval` function [here](./position-minting#giving-approval-to-transfer-our-tokens).
...
For a more detailed example, check out our [routing guide](../swapping/routing).
