...
Once you have minted a position, our next guide [Adding and Removing Liquidity](./modifying-position) will demonstrate how you can add and remove liquidity from that minted position!
