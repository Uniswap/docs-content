...
We described the `getTokenTransferApproval` function [here](./position-minting.md#giving-approval-to-transfer-our-tokens).
...
For a more detailed example, check out our [routing guide](../trading/routing).
