...
In this guide, we will take a look at the [Position](/docs/sdks/v3/overview) and [NonfungiblePositionManager](/docs/sdks/v3/overview) classes, as well as the [NonfungiblePositionManager Contract](/docs/protocols/v3/overview).
...
To create a position on a Pool, the [`mint`](/docs/protocols/v3/overview#mint) function is called on the Contract.
