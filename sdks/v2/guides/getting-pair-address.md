...
The most obvious way to get the address for a pair is to call [getPair](/docs/contracts/uniswap-protocol-contracts/v2/reference/smart-contracts/factory#getpair) on the factory. If the pair exists, this function will return its address, else `address(0)` (`0x0000000000000000000000000000000000000000`).
...
|                        |                                                                                |
| :--------------------- | :----------------------------------------------------------------------------- |
| `address`              | The [factory address](/docs/contracts/uniswap-protocol-contracts/v2/reference/smart-contracts/factory) |
