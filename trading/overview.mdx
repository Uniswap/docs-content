...
| :--- | :--- | :--- | :--- | :--- |
| **Custom Linking** | Simple Referrals | Directing users to the Uniswap Web App with pre-filled swap parameters. | Very Low | [Here](/docs/protocols/v2/concepts/custom-interface-links) |
...
The Uniswap API provides a straightforward path to integration. It abstracts away the complexity of finding a competitive route (splitting and hopping between Uniswap v2, v3, v4, and UniswapX) and constructing the transaction calldata. [Get started with the API](/docs/api/guides/swapping/getting-started).
