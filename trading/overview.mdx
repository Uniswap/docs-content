...
| **Uniswap API** | DApps, Wallets, Bots | A hosted API that handles routing, quoting, and transaction construction for you. | Low | [Here](/docs/trading/swapping-api/getting-started) |
...
The Uniswap API provides a straightforward path to integration. It abstracts away the complexity of finding a competitive route (splitting and hopping between Uniswap v2, v3, v4, and UniswapX) and constructing the transaction calldata. [Get started with the API](/docs/trading/swapping-api/getting-started).

[Get started with the API](/docs/trading/swapping-api/getting-started).
...
// Simulate the swap offchain to get a quote
