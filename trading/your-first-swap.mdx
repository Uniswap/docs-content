...
description: Understand swap integration paths on Uniswap using the Uniswap API, SDK, or Smart Contracts.
---
...
| Best For | Complexity | Full Guide |
| :--- | :--- | :--- |
| DApps, Wallets, Agents, Bots | Low | [Uniswap API](/docs/trading/swapping-api/integration-guide) |

Use the Uniswap API to integrate swapping quickly without implementing routing logic yourself.

### Step 1: Get your API key
Create an API key at [developers.uniswap.org/dashboard](https://developers.uniswap.org/dashboard/?utm_medium=eco&utm_source=platform&utm_campaign=20260404-dev-platform&utm_content=callout&utm_term=self-serve).
...
Call `/quote` to get the best available route and expected output for the current market.
...
Use routing from /quote to choose the next endpoint:
...
Sign with the user wallet, then broadcast through your RPC provider.
Your app handles nonce management, error handling, and status tracking.
...
npm i --save @uniswap/universal-router-sdk
```
...
And then import the Uniswap router interfaces.
...
- [Build with the Uniswap API](/docs/trading/swapping-api/integration-guide)
- [Build with the v4 SDK](/docs/sdks/v4/overview)
- [Build with v4 Protocol Guides](/docs/protocols/v4/overview)
- [Configure Custom Linking](/docs/trading/custom-interface-links)
