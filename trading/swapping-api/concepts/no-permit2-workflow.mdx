...
However, **using the [Permit2 flow](/docs/api/concepts/permit2) whenever possible is recommended**, as it provides better security and a more flexible approval model for users.
...
For guidance on the recommended integration, see the [Permit2 guide](/docs/api/concepts/permit2).