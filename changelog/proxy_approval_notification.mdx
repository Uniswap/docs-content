...
If you already have a workflow using Permit2, you don’t need to make any change. If you have struggled to integrate Permit2 approval, this new workflow may be for you. You can read the full [integration guide here](https://api-docs.uniswap.org/guides/no-permit2-workflow).
