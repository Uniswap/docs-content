...
The [whitepaper](/docs/liquidity/liquidity-launchpad/whitepaper_cca.pdf) is the most complete resource to understand the auction mechanics, but at a high level this is how the mechanism works:
