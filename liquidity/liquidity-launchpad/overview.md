...
The Uniswap Liquidity Launchpad is a framework for bootstrapping initial liquidity for Uniswap v4 pools through transparent price discovery (see [whitepaper](/docs/liquidity/liquidity-launchpad/guides/whitepaper_cca.pdf)). It combines three functions into a composable flow:
...
- Read the [CCA whitepaper](/docs/liquidity/liquidity-launchpad/guides/whitepaper_cca.pdf)
