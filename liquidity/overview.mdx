...
The Liquidity Launchpad is accessed via **smart contract interactions** with the Liquidity Launcher and strategy contracts onchain. The architecture is modular and permissionless — anyone can deploy an auction and bootstrap liquidity without gatekeepers.
