...
| :--- | :--- | :--- | :--- |
| **Liquidity Provisioning (LP)** | Deposit token pairs into Uniswap V2, V3, or V4 pools and earn fees from trades. | DeFi developers, treasury managers, yield strategists | [Here](/docs/liquidity/liquidity-provisioning-api/getting-started) |
