...
| [POST /lp/create](/docs/api-reference/create_lp_position) | Create a new Uniswap v3 or Uniswap v4 liquidity position |
| [POST /lp/create_classic](/docs/api-reference/create_classic) | Create a new Uniswap v2 liquidity position |
| [POST /lp/increase](/docs/api-reference/increase_lp_position) | Add liquidity to an existing Uniswap v2, v3, or v4 position |
| [POST /lp/decrease](/docs/api-reference/decrease_lp_position) | Remove liquidity from an existing Uniswap v2, v3, or v4 position |
| [POST /lp/claim](/docs/api-reference/claim_lp_fees) | Collect accumulated fees from a Uniswap v3 or Uniswap v4 position |
