...
import uniswapxArch from './images/UniswapX.png'

<img src={uniswapxArch} alt="UniswapX" style={{ width: '100%', margin: '0 auto' }} />
...
Some sample fill contract implementations are provided in this repository:
- [SwapRouter02Executor](https://github.com/Uniswap/UniswapX/blob/main/src/sample-executors/SwapRouter02Executor.sol): A fill contract that uses Uniswap v2 and Uniswap v3 via the `SwapRouter02` router

For filler implementation and operational guidance, see [/docs/liquidity/uniswapx/filling/overview](/docs/liquidity/uniswapx/filling/overview).
