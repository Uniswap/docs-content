...
- [Skills](/docs/ai-tooling/skills) -- Available plugins and installation
- [Evals](/docs/ai-tooling/evals) -- Evaluation framework
- [AI Toolkit Overview](/docs/ai-tooling/overview) -- Project overview