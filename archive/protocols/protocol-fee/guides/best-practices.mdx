...
description: Best practices for interacting with the Uniswap Protocol Fee system
---
...
Recall [`Firepit.release()`](/docs/protocols/protocol-fee/overview#release) requires a `_nonce` parameter that matches the contract storage [`Firepit.nonce()`](/docs/protocols/protocol-fee/overview#nonce).
...
For further reading, please see [Read Asset Balance](/docs/protocols/protocol-fee/guides/read-asset-balances)
...
[IV3FeeController.collect()](/docs/protocols/protocol-fee/overview#collect)
...
The Uniswap Protocol Fee system allows for an *updatable* [`Firepit.threshold()`](/docs/protocols/protocol-fee/overview#threshold)
...
For further reading, please see [Read Asset Balance](/docs/protocols/protocol-fee/guides/read-asset-balances#uniswap-v2-pool-protocol-fees)
