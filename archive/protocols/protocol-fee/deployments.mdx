...
To enable fees for v2 and v3 on *mainnet*, the [Deployer](/docs/protocols/protocol-fee/overview) handles the entire set up in one transaction. Subsequent transactions
