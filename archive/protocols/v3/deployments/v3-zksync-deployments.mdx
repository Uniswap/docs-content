...
You can look up the address of an existing pool on [Uniswap Info](https://app.uniswap.org/explore) or by calling the [`getPool`](/docs/protocols/v3/overview#getpool) function on the `UniswapV3Factory` contract.
