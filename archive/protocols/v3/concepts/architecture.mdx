...
> [**Factory Reference**](/docs/protocols/v3/overview)
...
> [**Pool Reference**](/docs/protocols/v3/overview).
...
> [**Swap Router Reference**](/docs/protocols/v3/overview)

> [**Swap Router Interface**](/docs/protocols/v3/overview)
...
> [**Nonfungible Position Manager Reference**](/docs/protocols/v3/overview)

> [**Nonfungible Position Manager Interface**](/docs/protocols/v3/overview)

The position manager handles the logic transactions involving the creation, adjustment, or exiting of positions.

### Oracle

> [**Oracle Reference**](/docs/protocols/v3/overview)
...
> [**Periphery Libraries**](/docs/protocols/v3/overview)
