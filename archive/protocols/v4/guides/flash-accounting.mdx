...
When adding liquidity to a pool, you’ll need to provide both tokens in the pair. The `modifyLiquidity` function returns a [`BalanceDelta`](/docs/protocols/v4/overview) that indicates how many tokens you need to provide. In this case:
