...
All Uniswap V2 pool tokens support meta-transaction approvals via the [permit](/docs/protocols/v2/overview#permit) function. This obviates the need for a blocking approve transaction before programmatic interactions with pool tokens can occur.
...
- `name` is always `Uniswap V2`, see [name](/docs/protocols/v2/overview#name).
