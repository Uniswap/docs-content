...
The easiest way to safely add liquidity to a pool is to use the [router](/docs/protocols/v2/overview), which provides simple methods to safely add liquidity to a pool. If the liquidity is to be added to an ERC-20/ERC-20 pair, use [addLiquidity](/docs/protocols/v2/overview#addliquidity). If WETH is involved, use [addLiquidityETH](/docs/protocols/v2/overview#addliquidityeth).
