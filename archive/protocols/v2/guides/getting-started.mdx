...
that runs on the [Ethereum Virtual Machine (EVM)](<https://eth.wiki/en/docs/get-started/evm/ethereum-virtual-machine-(evm)-awesome-list>).
...
The [`UniswapV2Library`](/docs/protocols/v2/overview) has some helpful methods for this.
