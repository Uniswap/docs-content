...
This section will walk you through each parameter of a CCA auction and an example configuration. For more details please refer to the [technical reference](/docs/protocols/liquidity-launchpad/concepts/cca).
...
For more details about the auction steps please refer to the [technical reference](/docs/protocols/liquidity-launchpad/concepts/cca#auction-steps-supply-issuance-schedule).

## Example configuration
Let's create an example configuration for a CCA auction. We'll use the script we started in the [previous section](/docs/protocols/liquidity-launchpad/guides/local-deployment).
